...
class Welcomer : ListenerAdapter() {
    ...
    override fun onGuildMemberJoin(event: GuildMemberJoinEvent) {
        ...
        if (event.member.user.isBot) {
            ...
            channel.sendMessage(MessageBuilder().appendFormat("Welcome %U%! We hope you have a good time here. Let me just ping the staff to give you a proper hello. Also, I'll give you your appropriate role now. %R%", event.member.user, event.guild.getRolesByName("administrator", true)).build()).queue {
