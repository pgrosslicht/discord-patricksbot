...
class OfflineWarner : ListenerAdapter() {
    ...
    private val ownerMap : Map<String, String> = HashMap<String, String>(mapOf("219898908074049547" to "103255776218345472", //Magic 8-Ball
    ...
    fun messageOwner(event: UserUpdateOnlineStatusEvent, owner: String, affectedBot: User) {
    ...
    fun messageOwnerOnline(event: UserUpdateOnlineStatusEvent, owner: String, affectedBot: User) {
